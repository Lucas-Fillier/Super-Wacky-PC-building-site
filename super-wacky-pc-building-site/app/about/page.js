export default function AboutPage(){
    return (
        <div>
            <h1>About Super Wacky PC Builder</h1>
            <p>A smarter way to plan your next gaming rig, built by students for CP4485</p>

            <h2>Why We Built This</h2>
            <p>We're big into gaming and building PCs, so we decided that are topic for our Emerging Trends projects, we wanted to make something we'd actually use. Figuring out if your parts are compatible or if a CPU will bottleneck your GPU usually means digging through Reddit threads and articles. We're building this app to put all that info in one clean interface.</p>
