...
export default function Navbar() {
    return (
        <nav className="relative flex items-center justify-between p-6 border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950 transition-colors duration-200">
            <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 tracking-tight">Super Wacky PC Builder</div>

            <ul className="absolute left-1/2 -translate-x-1/2 flex space-x-6 text-sm font-medium text-slate-600 dark:text-slate-300">
